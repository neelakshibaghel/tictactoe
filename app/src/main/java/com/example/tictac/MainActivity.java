...
public class MainActivity extends AppCompatActivity {
    ...
    private void winningGame(){
        if((b1==1) && (b2==1) && (b3==1)){
            ...
            builder.setMessage("Player X Winner").setCancelable(false).setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                @Override
            ...
            AlertDialog.Builder builder=new AlertDialog.Builder(this);
            builder.setMessage("Player O Winner").setCancelable(false).setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int which) {
                    button1.setImageDrawable(null);
                    button2.setImageDrawable(null);
            ...
            if(i==9){
                AlertDialog.Builder builder=new AlertDialog.Builder(this);
                builder.setMessage("No One Winner").setCancelable(false).setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int which) {
                        button1.setImageDrawable(null);
                        button2.setImageDrawable(null);
